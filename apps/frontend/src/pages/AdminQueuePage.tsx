...
const AdminQueueContent = () => {
  ...
  const dateFormatterLocale = i18n.language;
  ...
  const confirmReject = async (product: Product) => {
              ...
              {items.map((p) => (
                <TableRow key={p.id}>
                  ...
                  <TableCell className="text-muted-foreground">
                    {formatCreatedAt(p.createdAt, dateFormatterLocale)}
                  </TableCell>
                  <TableCell>
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={() => void confirmReject(rejectProduct as Product)}
              variant="destructive"
            >
