...
export const LoginPage = () => {
  ...
  return (
    <main>
      <PageSurface className="grid min-h-screen place-items-center p-4 sm:p-6">
        <div
        ...
        >
          <div className="bg-primary text-primary-foreground relative hidden overflow-hidden p-10 lg:block">
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div className="space-y-8">
                <h1 className="m-0">
                  <img alt={t("login.heroTitle")} className="h-12 w-auto" src="/fuga-logo.svg" />
                </h1>
          ...
          <div className="p-5 sm:p-8 lg:p-10 lg:pr-12">
            <header className="mb-10 flex items-center justify-end gap-4" role="banner">
            ...
            <Card className="border-0 bg-transparent shadow-none">
              ...
              <CardContent className="space-y-5 px-0 pb-0">
                {loading && firebaseReady && <StatusBanner>{t("status.loading")}</StatusBanner>}
                {!firebaseReady && (
